...
export async function generateMetadata({params,searchParams}:{params:Promise<{slug:string}>;searchParams:Promise<{page?:string}>}){return discoveryMetadata('be','topics',(await params).slug,(await searchParams).page);}
